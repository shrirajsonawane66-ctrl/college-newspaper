...
const steps: Step[] = [
  { id: "details", label: "Article Details", description: "Title, content & author" },
  { id: "thumbnail", label: "Thumbnail", description: "Upload or choose an image" },
  { id: "settings", label: "Settings", description: "SEO, tags & visibility" },
  { id: "preview", label: "Preview", description: "See how it looks" },
  { id: "publish", label: "Publish", description: "Release to readers" },
];
  ...
  return (
    <nav className="w-56 lg:w-64 min-h-screen bg-ink text-zinc-400 flex flex-col shrink-0 border-r border-zinc-800/50">
      <div className="p-5 border-b border-zinc-800">
        ...
        <p className="text-[8px] uppercase tracking-[0.25em] text-zinc-600 font-body font-semibold">Publishing Studio</p>
      </div>
